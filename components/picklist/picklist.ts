...
import { SharedModule, PrimeTemplate, FilterService } from 'primeng/components/api';
import { DomHandler } from 'primeng/components/dom';
import { RippleModule } from 'primeng/components/ripple';
import { CdkDragDrop, DragDropModule, moveItemInArray, transferArrayItem } from '@angular/cdk/drag-drop';
import { ObjectUtils, UniqueComponentId } from 'primeng/components/utils';
import { AngleDoubleDownIcon } from 'primeng/components/icons/angledoubledown';
import { AngleDoubleLeftIcon } from 'primeng/components/icons/angledoubleleft';
import { AngleDoubleRightIcon } from 'primeng/components/icons/angledoubleright';
import { AngleDoubleUpIcon } from 'primeng/components/icons/angledoubleup';
import { AngleDownIcon } from 'primeng/components/icons/angledown';
import { AngleLeftIcon } from 'primeng/components/icons/angleleft';
import { AngleRightIcon } from 'primeng/components/icons/angleright';
import { AngleUpIcon } from 'primeng/components/icons/angleup';
import { SearchIcon } from 'primeng/components/icons/search';
import { HomeIcon } from 'primeng/components/icons/home';

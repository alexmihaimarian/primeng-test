...
import { Footer, SharedModule, PrimeTemplate, PrimeNGConfig, TranslationKeys, ConfirmEventType } from 'primeng/components/api';
import { ButtonModule } from 'primeng/components/button';
import { Confirmation } from 'primeng/components/api';
import { ConfirmationService } from 'primeng/components/api';

...
import { OverlayOptions, OverlayService, PrimeNGConfig, PrimeTemplate, SharedModule, TreeNode } from 'primeng/components/api';
...
import { Tree, TreeModule } from 'primeng/components/tree';
